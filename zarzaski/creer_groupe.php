...
<head>
    ...
    <title>Création de votre groupe</title>
...
<body>
    ...
    <section class="modifier" id="modifier">
        ...
        <div class="champs" style="margin: 0">
            <div class="champ">
                <form action="./verif_creer_groupe.php" method="post">
                <label for="nom">Nom de groupe</label><br>
                <input type="text" name="nom" id="nom" pattern="[a-zA-Z0-9]+" placeholder="caractères alphanumériques" required /><br>
            </div>
